...
# Same as before, but trajectories are simulated regenerating clocks only when previous one is reached, or when treatment changes.

OurStratNew<-function(nsim,step,std=TRUE,round=2,cost="simple",seed=212121)
{
