...
Rscript Scripts-Paper/3_RunDynProg.R 184 L2 FALSE FALSE
...
Rscript Scripts-Paper/3_RunDynProg.R 319 L2 FALSE FALSE
echo "Removing unused points"
...
echo "Running dynamic programming"
Rscript Scripts-Paper/3_RunDynProg.R 549 L2 FALSE FALSE
echo "Removing unused points"
...
echo "Running dynamic programming"
Rscript Scripts-Paper/3_RunDynProg.R 722 L2 FALSE FALSE
echo "Removing unused points"
...
echo "Running dynamic programming"
Rscript Scripts-Paper/3_RunDynProg.R 989 L2 FALSE FALSE
...
echo "Running dynamic programming on initial grid"
Rscript Scripts-Paper/3_RunDynProg.R 184 Lm FALSE FALSE
echo "Removing unused points"
...
echo "Running dynamic programming"
Rscript Scripts-Paper/3_RunDynProg.R 310 Lm FALSE FALSE
echo "Removing unused points"
...
echo "Running dynamic programming"
Rscript Scripts-Paper/3_RunDynProg.R 545 Lm FALSE FALSE
echo "Removing unused points"
...
echo "Running dynamic programming"
Rscript Scripts-Paper/3_RunDynProg.R 709 Lm FALSE FALSE
echo "Removing unused points"
...
echo "Running dynamic programming"
Rscript Scripts-Paper/3_RunDynProg.R 1021 Lm FALSE FALSE
