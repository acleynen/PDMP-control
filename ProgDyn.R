ProgD<-function()
{
	...
	save(Decsimple,Vprogsimple,Decint,Vprogint,file=paste('RData/ProgDyn_', grid,"-", type,'_timeall_CV', CVs,'.RData', sep=""))
	...
	save(Decsimple,Vprogsimple,Decint,Vprogint,file=paste('RData/ProgDyn_', grid,"-", type,'_time15_CV', CVs,'.RData', sep=""))
	...
	save(Decsimple,Vprogsimple,Decint,Vprogint,file=paste('RData/ProgDyn_', grid,"-", type,'_time60_CV', CVs,'.RData', sep=""))
